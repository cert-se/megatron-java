...
public abstract class BaseContact  implements Serializable, Comparable<Object>{
	 ...
	 * @param emailType the email_type value
	 */
	 ...
	 * @param emailAddress the external_reference value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof se.sitic.megatron.entity.Contact)) return false;
		else {
			se.sitic.megatron.entity.Contact contact = (se.sitic.megatron.entity.Contact) obj;
			if (null == this.getId() || null == contact.getId()) return false;
			else return (this.getId().equals(contact.getId()));
		}
	}
